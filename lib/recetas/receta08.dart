...
final String _quote = titulo08;

class Receta08 extends StatefulWidget {
  @override
  State<Receta08> createState() => _PageState();
}

class _PageState extends State<Receta08> {
...
Widget _texto() {
  return Padding(
    ...
    child: StyledText(
      text: '''
Vamos a crear la receta en este texto.
''',
      style: tamanoTexto,
      tags: {
