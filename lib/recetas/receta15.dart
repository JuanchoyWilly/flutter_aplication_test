...
final String _quote = titulo15;

class Receta15 extends StatefulWidget {
  @override
  State<Receta15> createState() => _PageState();
}

class _PageState extends State<Receta15> {
...
Widget _texto() {
  return Padding(
    ...
    child: StyledText(
      text: '''
Cocinar la receta en este texto.
''',
      style: tamanoTexto,
      tags: {
