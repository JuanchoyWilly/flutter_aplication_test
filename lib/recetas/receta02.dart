...
final String _quote = titulo02;

class Receta02 extends StatefulWidget {
  @override
  State<Receta02> createState() => _PageState();
}

class _PageState extends State<Receta02> {
...
Widget _texto() {
  return Padding(
    ...
    child: StyledText(
      text: '''
Creación de la receta en este texto.
''',
      style: tamanoTexto,
      tags: {
