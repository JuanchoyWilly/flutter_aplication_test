...
final String _quote = titulo17;

class Receta17 extends StatefulWidget {
  @override
  State<Receta17> createState() => _PageState();
}

class _PageState extends State<Receta17> {
  @override
...
Widget _texto() {
  return Padding(
    ...
    child: StyledText(
      text: '''
Preparación de la receta en este texto.
''',
      style: tamanoTexto,
      tags: {
