...
final String _quote = titulo01;

class Receta01 extends StatefulWidget {
  @override
  State<Receta01> createState() => _PageState();
}

class _PageState extends State<Receta01> {
...
Widget _texto() {
  return Padding(
    ...
    child: StyledText(
      text: '''
Elaboración de la receta en este texto.
''',
      style: tamanoTexto,
      tags: {
